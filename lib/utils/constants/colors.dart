...
class TColors {
  // App theme colors
  static const Color primary = Color(0xFF9B51E0);
  ...
  static Color darkContainer = TColors.white.withValues(alpha: 25);

  // Button colors
  static const Color buttonPrimary = Color(0xFF9B51E0);
  ...
  // Additional colors for driver screens
